                            ...
                            <div class="iq-card-body">
                                <ul class="m-0 p-0">
                                    <li class="d-flex mb-2">
                                        ...
                                        <p class="news-detail mb-0">there is a meetup in your city on fryday at
                                            19:00. <a href="#">see details</a></p>
                                    </li>
                                    <li class="d-flex">
                                        <div class="news-icon mb-0"><i class="ri-chat-4-fill"></i></div>
                                        <p class="news-detail mb-0">20% off coupon on selected items at pharmaprix
                                        </p>
                                    </li>
                                </ul>
                            </div>
                                ...
                                <ul class="pages-lists m-0 p-0">
                                    <li class="d-flex mb-4 align-items-center">
                                        ...
                                        <div class="add-suggestion">
                                            <a href="javascript:void();" class="text-warning"><i
                                                    class="ri-star-half-line"></i></a>
                                        </div>
                                    </li>
                                    <li class="d-flex mb-4 align-items-center">
                                        <div class="user-img img-fluid"><img
                            ...
                            <div class="tab-pane fade active show" id="profile-feed" role="tabpanel">
                                                ...
                                                <div class="iq-card-header-toolbar d-flex align-items-center">
                                                    <div class="dropdown">
                                                        <span class="dropdown-toggle text-primary"
                                                            id="dropdownMenuButton52" data-toggle="dropdown">
                                                        ...
                                                        <div class="dropdown-menu dropdown-menu-right p-0">
                                                            ...
                                                            <a class="dropdown-item" href="#"><i
                                                                    class="ri-file-copy-line mr-2"></i>Copy
                                                                Link</a>
                                                        </div>
                                                    </div>
                                                </div>
                                ...
                                <div class="iq-card">
                                    <div class="iq-card-body p-0">
                                        <div class="user-post-data p-3">
                                            <div class="d-flex flex-wrap">
                                                ...
                                                <div class="iq-card-header-toolbar d-flex align-items-center">
                                                    <div class="dropdown">
                                                        <span class="dropdown-toggle text-primary"
                                                            id="dropdownMenuButton53" data-toggle="dropdown">
                                        ...
                                        <hr class="mt-0">
                                        <p class="p-3 mb-0">Lorem ipsum dolor sit amet, consectetur
                            ...
                            <div class="tab-pane fade" id="profile-friends" role="tabpanel">
                                <div class="iq-card">
                                    ...
                                    <div class="iq-card-body">
                                        <ul class="suggestions-lists m-0 p-0">
                                            <li class="d-flex mb-4 align-items-center">
                                                ...
                                                <div class="iq-card-header-toolbar d-flex align-items-center">
                                                    <div class="dropdown">
                                                        <span class="dropdown-toggle text-primary"
                                                            id="dropdownMenuButton41" data-toggle="dropdown">
                                            ...
                                            <li class="d-flex mb-4 align-items-center">
                                                ...
                                                <div class="iq-card-header-toolbar d-flex align-items-center">
                                                    <div class="dropdown">
                                                        <span class="dropdown-toggle text-primary"
                                                            id="dropdownMenuButton42" data-toggle="dropdown">
                                                            <i class="ri-more-2-line"></i>
                                                        </span>
                                                        <div class="dropdown-menu dropdown-menu-right p-0">
                                                            <a class="dropdown-item" href="#"><i
                                            ...
                                            <li class="d-flex mb-4 align-items-center">
                                                ...
                                                <div class="iq-card-header-toolbar d-flex align-items-center">
                                                    <div class="dropdown">
                                                        <span class="dropdown-toggle text-primary"
                                                            id="dropdownMenuButton43" data-toggle="dropdown">
                                                            <i class="ri-more-2-line"></i>
                                                        </span>
                                                        <div class="dropdown-menu dropdown-menu-right p-0">
                                                            <a class="dropdown-item" href="#"><i
                                            ...
                                            <li class="d-flex mb-4 align-items-center">
                                                ...
                                                <div class="iq-card-header-toolbar d-flex align-items-center">
                                                    <div class="dropdown">
                                                        <span class="dropdown-toggle text-primary"
                                                            id="dropdownMenuButton44" data-toggle="dropdown">
                                                            <i class="ri-more-2-line"></i>
                                                        </span>
                                                        <div class="dropdown-menu dropdown-menu-right p-0">
                                                            <a class="dropdown-item" href="#"><i
                                            ...
                                            <li class="d-flex mb-4 align-items-center">
                                                ...
                                                <div class="iq-card-header-toolbar d-flex align-items-center">
                                                    <div class="dropdown">
                                                        <span class="dropdown-toggle text-primary"
                                                            id="dropdownMenuButton45" data-toggle="dropdown">
                                                            <i class="ri-more-2-line"></i>
                                                        </span>
                                                        <div class="dropdown-menu dropdown-menu-right p-0">
                                                            <a class="dropdown-item" href="#"><i
                                            ...
                                            <li class="d-flex mb-4 align-items-center">
                                                ...
                                                <div class="iq-card-header-toolbar d-flex align-items-center">
                                                    <div class="dropdown">
                                                        <span class="dropdown-toggle text-primary"
                                                            id="dropdownMenuButton46" data-toggle="dropdown">
                                                            <i class="ri-more-2-line"></i>
                                                        </span>
                                                        <div class="dropdown-menu dropdown-menu-right p-0">
                                                            <a class="dropdown-item" href="#"><i
                                            ...
                                            <li class="d-flex mb-4 align-items-center">
                                                ...
                                                <div class="iq-card-header-toolbar d-flex align-items-center">
                                                    <div class="dropdown">
                                                        <span class="dropdown-toggle text-primary"
                                                            id="dropdownMenuButton47" data-toggle="dropdown">
                                                            <i class="ri-more-2-line"></i>
                                                        </span>
                                                        <div class="dropdown-menu dropdown-menu-right p-0">
                                                            <a class="dropdown-item" href="#"><i
                                        ...
                                        <a href="javascript:void();" class="btn btn-primary d-block"><i
                                ...
                                <div class="iq-card">
                                    ...
                                    <div class="iq-card-body">
                                        ...
                                        <div class="mt-2">
                                            ...
                                            <h6>Url:</h6>
                                            <p><a href="https://getbootstrap.com/docs/4.0/getting-started/introduction/"
                                                    target="_blank"> www.bootstrap.com </a></p>
                                        </div>
                                        <div class="mt-2">
                                            <h6>Contact:</h6>
                            ...
                            <div class="iq-card-body">
                                <div class="about-info m-0 p-0">
                                    <div class="row">
                                        ...
                                        <div class="col-9"><a href="mailto:nikjone@demoo.com">
                                                nikjone@demoo.com </a></div>
                                        <div class="col-3">Phone:</div>
                                        <div class="col-9"><a href="#">001 2351 256 12</a></div>
                            ...
                            <div class="iq-card-body">
                                <ul class="media-story m-0 p-0">
                                    <li class="d-flex mb-4 align-items-center active">
                                        <img src="images/page-img/s1.jpg" alt="story-img"
                                    ...
                                    <li class="d-flex mb-4 align-items-center">
                                        <img src="images/page-img/s2.jpg" alt="story-img"
                                            class="rounded-circle img-fluid" />
                                        <div class="stories-data ml-3">
                                            <h5>App Design</h5>
                                    ...
                                    <li class="d-flex align-items-center">
                                        <img src="images/page-img/s3.jpg" alt="story-img"
                                            class="rounded-circle img-fluid" />
                                        <div class="stories-data ml-3">
                            ...
                            <div class="iq-card-body">
                                <ul class="suggestions-lists m-0 p-0">
                                    <li class="d-flex mb-4 align-items-center">
                                        ...
                                        <div class="add-suggestion"><a href="javascript:void();"><i
