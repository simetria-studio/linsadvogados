...
use App\Http\Controllers\Paginas\PrazosController;
...
use App\Http\Controllers\Paginas\ProcessosController;
...
Route::middleware(['auth'])->group(function () {
    ...
    Route::get('prazos', [PrazosController::class, 'index'])->name('prazos');
    Route::post('prazos/store', [PrazosController::class, 'store'])->name('prazo.store');
    Route::any('prazosDelete/{id}', [PrazosController::class, 'destroy'])->name('prazo.delete');


    Route::get('precessos', [ProcessosController::class, 'index'])->name('processos');
    Route::post('precessos/store', [ProcessosController::class, 'store'])->name('processos.store');
